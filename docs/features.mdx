...
`;
	...
	const { Text, speechStatus, start, pause, stop } = useSpeech({ text: reactContent, pitch: 1, rate: 1, volume: 1, lang: "en-CA", voiceURI: "Microsoft Richard - English (Canada)", autoPlay: false, highlightText: true, showOnlyHighlightedText: false, highlightMode: "word" });
